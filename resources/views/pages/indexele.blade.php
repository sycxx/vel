...
<div class="banner text-center" data-scroll-index='0'>
    <div class="banner-overlay">
      <div class="container">
        <img src="{{asset('images/vista-bulat.png')}}" alt="logo" class="img-responsive">
        <h1 class="text-capitalize">Vista Maritim Indonesia</h1>
        <p>Was founded in January 2007 by Mr. Hadi in Batam, Indonesia, <br>Starts in spesialist aluminium boat shipbuilder and
           repair industry. <br>Now, we have successfully completed a range of fabrication, outfitting, piping, painting, mechanical
           and electrical works in more than a hundred steel and aluminium vessels. <br>Pilot boat, patrol boats, passenger ferries, crewboats, fast supply vessels or even a fishing boat, just mention it.
           <br> We will develop for you.
        </p>
...
<div class="about-us section-padding" data-scroll-index='1'>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 mb-50">
          <div class="section-img"> <img src="{{asset('images/vision_5.jpg')}}" alt="" class="img-responsive"/> </div>
        </div>
      </div>
    </div>
</div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 section-title text-center">
          ...
          <p>Fabrication, outfitting, piping, painting, mechanical and electrical works.</p>
          <span class="section-title-line"></span> </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-30">
          <div class="service-box bg-white text-center">
            ...
            <div class="icon-text">
              <h4 class="title-box">Headquarter</h4>
              <p>Sed malesuada, est eget condimentum iaculis, nisi ex facilisis metus.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-30">
          <div class="service-box bg-white text-center">
            ...
            <div class="icon-text">
              <h4 class="title-box">Painting</h4>
              <p>Sed malesuada, est eget condimentum iaculis, nisi ex facilisis metus.</p>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="filtering text-center mb-30">
          ...
          <button type="button" data-filter='.summer'>Hull</button>
          <button type="button" data-filter='.winter'>Repairing</button>
          <button type="button" data-filter='.project'>Projects</button>
          <button type="button" data-filter='.teamwork'>Teamwork</button>
        </div>
        <div class="gallery no-padding col-lg-12 col-sm-12">
          <div class="col-lg-4 col-sm-6 teamwork no-padding">
            <div class="item-img"> <a class="single-image" href="images/gall1.jpg"></a>
              <div class="part-img"> <img src="images/contactus.jpg" alt="image">
          ...
          <div class="col-lg-4 col-sm-6 project no-padding">
...
<div class="testimonials">
        ...
        <div class="col-lg-5 col-md-4">
          <div class="part-info">
            ...
            <div class="info-box">
              ...
              <div class="content">
                <h4>Address :</h4>
                <p>Komplek Bintang Industrial Park II
                  Blok D No.42, Tanjung Uncang
                  Batam 29400, Indonesia
                  Tel (HQ) : +62 778 391200 
                  Tel (24 hrs) : +62 812 703 5167 
                  Fax : +62 778 391 107</p><br>
                <h4>Operating Base:</h4>
                <p>Workshop 2 
                  Kawasan Industri Sekupang,
                  Kel Tg Riau No. 61,
                  Sekupang, Indonesia</p>
              </div>
            </div>
            <div class="info-box">
              ...
              <div class="content">
                <h4>Mail :</h4>
                <p><a href="#">Support@vistamaritim.com</a></p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="controls">
                <div class="row">
                  ...
                  <div class="col-lg-12 text-center">
                    <button class="bttn">Send Us Message</button>
                  </div>
                </div>
              </div>
            </form>
  ...
  <!-- End Contact -->
  <footer class="footer-latar">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <p>2018 &copy; Vista Maritim INDONESIA.<a href="#" target="_blank" rel="dofollow"></a></p>
        </div>
      </div>
    </div>
  </footer>
  ...
  navbar.addClass("nav-scroll");
  $('.navbar-logo img').attr('src','images/tes12.png');
